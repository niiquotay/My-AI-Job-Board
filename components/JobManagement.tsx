              ...
              <div className="p-4 md:p-5 border-b border-white/5 flex items-center justify-between bg-white/[0.02] shrink-0">
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                       ...
                       <p className="text-[8px] text-white/30 font-black uppercase tracking-[0.4em]">AI-JobConnect Organizational Protocol v4.2</p>
                    </div>
                 </div>
                   ...
                   <div className="space-y-12 animate-in slide-in-from-right-4 py-8">
                      ...
                      <div className="space-y-8">
                        ...
                        <div className="bg-blue-400/5 border border-blue-400/20 rounded-[32px] p-8 flex items-center gap-8 shadow-inner">
                           ...
                           <div><p className="text-lg font-black uppercase tracking-tight">Compliance & Integrity Check Passed</p><p className="text-sm text-white/40 font-medium">This manifest adheres to AI-JobConnect global organizational standards.</p></div>
                        </div>
                      </div>
                   </div>
                 )}
